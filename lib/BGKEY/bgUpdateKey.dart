...
class BgUpdateKey extends StatefulWidget {
  const BgUpdateKey({Key? key}) : super(key: key);
  @override
  _BgUpdateKeyState createState() => _BgUpdateKeyState();
}
class _BgUpdateKeyState extends State<BgUpdateKey> {
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            // Container for displaying generated license key
            Container(
